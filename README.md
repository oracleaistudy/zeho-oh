...
4️⃣ 각 장(`.ipynb` 파일)을 열어 이론과 코드를 함께 학습하세요.
...
| 구분 | 링크 |
|------|------|
| 📗 교재 | [혼자 공부하는 머신러닝+딥러닝](https://www.hanbit.co.kr/store/books/look.php?p_code=B7033438574) |
| 🧩 사이킷런 공식 문서 | [https://scikit-learn.org/stable/](https://scikit-learn.org/stable/) |
| 🧠 텐서플로 공식 문서 | [https://www.tensorflow.org/?hl=ko](https://www.tensorflow.org/?hl=ko) |
| 📊 케라스 문서 | [https://keras.io/ko/](https://keras.io/ko/) |
...
|------|------|
| **이름** | Jay Oh |
| **분야** | Python / Machine Learning / Deep Learning / Data Analysis |
| **문의 및 제안** | Issue 또는 Pull Request로 남겨주세요 🙌 |
